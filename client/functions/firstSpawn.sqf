...
[format ['Hello %1! <br/>Please visit the change log for updates.<br/>Have fun and play fair!', name player], "Welcome to g4-gamers.com Chernarus"] spawn BIS_fnc_guiMessage;
